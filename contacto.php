...
<body class="bg-light">
    ...
    <section class="container section-bajo-navbar">
        <div class="text-center mb-5">
            ...
            <p class="text-muted">¿Interesado en conocer más sobre nuestros desarrollos? Completá el formulario y un asesor especializado se pondrá en contacto contigo a la brevedad.</p>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                <div class="bg-white p-4 rounded shadow-sm">
                    <h5 class="fw-bold mb-4">Solicitar Información</h5>
                    <form>
                        <div class="row mb-3">
                        ...
                        <div class="d-flex justify-content-center">
                            <a href="https://wa.me/549XXXXXXXXXX" class="btn btn-success fw-bold px-4 py-2 rounded-pill">
                                <i></i>Enviar Consulta
                            </a>
                        </div>
                    </form>
